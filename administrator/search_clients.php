...
<table class="form__table">
  <tr>
      ...
      <th>El.paštas</th>
      <th>Tel. nr.</th>
      <th class="extra">Įvertinimas</th>
      <th class="extra">Kliento ID</th>
      <th>Šalinimas</th>
  </tr>
  <?php
    foreach ($data as $key => $val) {
      echo 
        "<tr>"
          ...
          . "<td>{$val['el_pastas']}</td>"
          . "<td>{$val['tel_nr']}</td>"
          . "<td class='extra'>{$val['ivertinimas']}</td>"
          . "<td>{$val['id_klientas']}</td>"
          . "<td><a class=form__link href=delete_clients.php?id=".$val['id_klientas'].">Šalinti</a></td>"
        ."</tr>";
    }
  ?>
</table>
